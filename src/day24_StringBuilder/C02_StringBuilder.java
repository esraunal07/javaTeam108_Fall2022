...
public class C02_StringBuilder {
    public static void main(String[] args) {
        ...
        //Strinbuilder'i stringe cevirirsek veya string dondurecek methodlar kullanirsak
        //String'in inmutable ozelligi devreye girer ve yapilan degisiklikler kalici olmaz.

        //  sb=sb.toString().toUpperCase();
        //nonprimitive data turlerinde farkli data turunden variable atama yapilmaz
